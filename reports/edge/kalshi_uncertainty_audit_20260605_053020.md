...
- ledger: `data\paper\experiments\shadow_clean_30min_20260605_041831_decisions.jsonl`
...
- Median calibration buffer (recomputed): **15.65c** (row-based). Median model-uncertainty buffer: **5.15c** (ensemble disagreement vs market, NOT the fixed 3c fallback).
- Buffer is **BIAS-DOMINATED**: median bias (mean_pred − mean_actual) = **10.64c**, median sampling (Wilson half-width) = **0.69c** (bias is 93% of the buffer).
- Using DISTINCT WINDOWS instead of rows makes the buffer **LARGER** (row 11.48c vs window 11.56c) — row-vs-window overcounting is NOT inflating the buffer; if anything it understates it.
...
- required edge median 24.43c
- final policy edge median -13.80c, best -5.61c, range (-16.99, -5.61)
...
| [0.3,0.4) | 4387 | 228 | 19.24 | 0.209 | 0.268 | 0.358 | 15.65 | 14.87 | 0.78 | 12.70 | 0.023 |
| [0.4,0.5) | 3574 | 241 | 14.83 | 0.317 | 0.344 | 0.422 | 11.48 | 10.50 | 0.99 | 11.56 | 0.016 |
| [0.5,0.6) | 1407 | 215 | 6.54 | 0.403 | 0.414 | 0.578 | 19.17 | 17.50 | 1.66 | 20.63 | 0.021 |
| [0.7,0.8) | 7919 | 220 | 36.0 | 0.640 | 0.536 | 0.743 | 10.94 | 10.24 | 0.69 | 24.72 | 0.015 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| KXBTC15M-26JUN050030-30 | 292 | YES | 0.732 | 0.54 | 0.535 | 19.19 | 10.94 | -5.61 | 0.484 |
...
| KXBTC15M-26JUN050030-30 | 289 | YES | 0.732 | 0.62 | 0.614 | 11.19 | 10.94 | -9.65 | 0.523 |
