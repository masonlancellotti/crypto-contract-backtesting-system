...
_Generated 2026-06-09 03:22:11 UTC. HIGH-RES v2 on `kalshi_hires_joined_snapshots`. READ-ONLY research; no paper/live/orders/promotion. Settlement labels used for EVALUATION only; the underlying-implied PROXY is diagnostic, not truth._
...
- **q1_sufficient** YES — 39119 joined rows across 54 windows, 2 day(s).
- **q2_rows_windows** 39119 joined rows; 54 distinct windows; days=['2026-06-08', '2026-06-09'].
