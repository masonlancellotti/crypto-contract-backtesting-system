...
_Generated 2026-06-10 04:59:23 UTC. HIGH-RES v2 on `kalshi_hires_joined_snapshots`. READ-ONLY research; no paper/live/orders/promotion. Settlement labels used for EVALUATION only; the underlying-implied PROXY is diagnostic, not truth._
...
- **q1_sufficient** YES - 143462 joined rows across 156 windows, 3 day(s).
- **q2_rows_windows** 143462 joined rows; 156 distinct windows; days=['2026-06-08', '2026-06-09', '2026-06-10'].
