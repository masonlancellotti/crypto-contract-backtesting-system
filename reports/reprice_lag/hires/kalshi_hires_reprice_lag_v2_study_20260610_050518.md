...
_Generated 2026-06-10 05:05:18 UTC. HIGH-RES v2 on `kalshi_hires_joined_snapshots`. READ-ONLY research; no paper/live/orders/promotion. Settlement labels used for EVALUATION only; the underlying-implied PROXY is diagnostic, not truth._
...
- **q1_sufficient** YES - 42565 joined rows across 21 windows, 1 day(s).
- **q2_rows_windows** 42565 joined rows; 21 distinct windows; days=['2026-06-10'].
