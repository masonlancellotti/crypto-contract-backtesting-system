...
_Generated 2026-06-10 14:21:25 UTC. HIGH-RES v2 on `kalshi_hires_joined_snapshots`. READ-ONLY research; no paper/live/orders/promotion. Settlement labels used for EVALUATION only; the underlying-implied PROXY is diagnostic, not truth._
...
- **q1_sufficient** YES - 214221 joined rows across 58 windows, 1 day(s).
- **q2_rows_windows** 214221 joined rows; 58 distinct windows; days=['2026-06-10'].
...
- **q5_speed** Time-to-first Kalshi move >=2c: median 5103ms (>=1c: 4899ms) - bounded below by the ~1.1s book cadence.
