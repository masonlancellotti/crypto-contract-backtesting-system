...
_READ-ONLY MARKET DATA ONLY - NO ORDERS. Generated 2026-06-10 15:46:43 UTC. No orders, no paper/live, no promotion. Secrets are never printed (presence/booleans only)._
...
- active_ticker: KXBTC15M-26JUN101200-00
- **status: OK**
- blocker: none
- connected: True  subscribed: True
- connect_header_arg_used: additional_headers
- book messages: 12292  updates/s: 409.73
- median interarrival ms: 0  **sub-second book updates available: True**
- message types: {'subscribed': 1, 'orderbook_snapshot': 1, 'orderbook_delta': 12291}
- recv age ms: {'median': 14, 'p95': 19, 'max': 130}
