...
_READ-ONLY MARKET DATA ONLY - NO ORDERS. Generated 2026-06-09 04:18:39 UTC. No orders, no paper/live, no promotion. Secrets are never printed (presence/booleans only)._
...
- book messages: 3564  updates/s: 118.8
- median interarrival ms: 0  **sub-second book updates available: True**
- message types: {'subscribed': 1, 'orderbook_snapshot': 1, 'orderbook_delta': 3563}
- recv age ms: {'median': 53, 'p95': 64, 'max': 121}
