...
_READ-ONLY MARKET DATA ONLY - NO ORDERS. Generated 2026-06-10 03:16:55 UTC. No orders, no paper/live, no promotion. Secrets are never printed (presence/booleans only)._
...
- active_ticker: KXBTC15M-26JUN092330-30
- **status: OK**
- blocker: none
- connected: True  subscribed: True
- connect_header_arg_used: additional_headers
- book messages: 7178  updates/s: 239.27
- median interarrival ms: 0  **sub-second book updates available: True**
- message types: {'subscribed': 1, 'orderbook_snapshot': 1, 'orderbook_delta': 7177}
- recv age ms: {'median': 18, 'p95': 54, 'max': 165}
