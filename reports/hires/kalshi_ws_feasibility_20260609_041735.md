...
_READ-ONLY MARKET DATA ONLY - NO ORDERS. Generated 2026-06-09 04:17:35 UTC. No orders, no paper/live, no promotion. Secrets are never printed (presence/booleans only)._
...
- book messages: 3417  updates/s: 113.9
- median interarrival ms: 0  **sub-second book updates available: True**
- message types: {'subscribed': 1, 'orderbook_snapshot': 1, 'orderbook_delta': 3416}
- recv age ms: {'median': 55, 'p95': 59, 'max': 134}
